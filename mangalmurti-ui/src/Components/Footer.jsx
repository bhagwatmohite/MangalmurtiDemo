        ...
        <div className="container py-5">
          <div className="row g-5">
            <div className="col-lg-3 col-md-6">
              ...
              <p className="mb-2"><i className="fa fa-map-marker-alt me-3"></i>Gate No-96 villagekesnand,Taluka Havli Dist Pune.
              </p>
              <p className="mb-2"><i className="fa fa-phone-alt me-3"></i>+012 345 67890</p>
              <p className="mb-2"><i className="fa fa-envelope me-3"></i>mangalmurti5222@gmail.com</p>
